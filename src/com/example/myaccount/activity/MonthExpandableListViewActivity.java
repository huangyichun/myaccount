...
public class MonthExpandableListViewActivity extends ExpandableListActivity
	...
	private void setView() {
		...
		tv_back.setText(year + "年" + month + "月");
	...
	private void initData() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				WeekConsume wc = new WeekConsume(type, ""
	...
	public boolean onChildClick(ExpandableListView parent, View v,
		...
		case "兼职收入":
		case "其他收入":
			intent = new Intent(MonthExpandableListViewActivity.this,
	...
	protected void onResume() {
		...
		adapter = new WeekAdapter(MonthExpandableListViewActivity.this,
