...
public class NewInputActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_input_layout);
	...
	public void onClick(View v) {
		...
		case R.id.rl_new_output:
			intent = new Intent(NewInputActivity.this, NewOutputActivity.class);
		...
		case R.id.rl_output_type:
			final String item1[] = { "工资收入	", "利息收入", "加班收入", "奖金收入", "投资收入",
					"兼职收入", "其他收入" };
			dialog = new AlertDialog.Builder(NewInputActivity.this);
